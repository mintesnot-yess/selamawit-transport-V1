  ...
  <div class="flex flex-col gap-6 p-6 rounded-xl border shadow-sm bg-card">
    ...
    <div class="rounded-lg overflow-hidden">
      <Table
        ...
        filter-select-column="current_condition"
        filter-select-label="Condition"
    ...
    <Panel
      v-model="showPanel"
      :title="isUpdate ? 'Update Order Information' : 'Create  Order'"
      :description="
      ...
      >
        <div class="flex-1 space-y-2 overflow-y-scroll py-3 px-2">
          ...
          <FormField name="clients">
            <FormItem class="space-y-1">
              ...
              <Select v-model="form.client_id">
                ...
                <SelectContent
                  class="rounded-md shadow-lg border border-gray-200 bg-white"
                >
                  <SelectItem
          ...
          <FormField name="Loading">
            <FormItem class="space-y-1">
              <FormLabel class="block text-sm font-medium"
                >Loading Place</FormLabel
              >
          ...
          <FormField name="given_tariff">
            <FormItem class="space-y-1">
              <FormLabel class="block text-sm font-medium"
                >Given Tariff</FormLabel
              >
              <FormControl>
                <Input
                  type="number"
                  v-model="form.given_tariff"
                  class="w-full border-gray-300 rounded-md focus:ring-2 focus:ring-green-500 focus:border-green-500"
                />
              </FormControl>
              <FormMessage class="text-xs text-red-500" />
          ...
          <FormField name="sub_tariff">
            <FormItem class="space-y-1">
              <FormLabel class="block text-sm font-medium"
                >Sub Tariff</FormLabel
              >
              <FormControl>
                <Input
                  type="number"
                  v-model="form.sub_tariff"
                  class="w-full border-gray-300 rounded-md focus:ring-2 focus:ring-green-500 focus:border-green-500"
                />
              </FormControl>
              <FormMessage class="text-xs text-red-500" />
          ...
          <div class="pt-2">
            <div class="grid grid-cols-2 gap-4">
              <FormField name="arrival_at_loading_site">
                <FormItem class="space-y-1">
                  <FormLabel class="block text-sm font-medium"
                    >Arrival at Loading Site</FormLabel
                  >
                  <FormControl>
                    <Input
                      type="date"
                      v-model="form.arrival_at_loading_site"
